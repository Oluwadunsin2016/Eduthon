<template>
  <div class="my-8">
    ...
    >
      ...
      <div v-if="this.$store.state.student_information.guardian_id>0" class="flex items-center gap-2">
    ...
    <div v-if="this.$store.state.student_information.guardian_id>0" class="m-4 px-4 py-6 rounded-md shadow-md">
